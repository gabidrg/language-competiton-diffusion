@ECHO OFF
TITLE LanguageCompetitionDiffusion
...
CD LanguageCompetitionDiffusion

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./LanguageCompetitionDiffusion.rs
